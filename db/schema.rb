...
ActiveRecord::Schema.define(version: 20160527122730) do
  ...
  create_table "boards", force: :cascade do |t|
    ...
    t.string   "inventory_integration_method_other"
    t.string   "contact_other_title"
    t.string   "contact_other_name"
    t.string   "contact_other_phone"
    t.string   "contact_other_email"
    t.string   "contact_other_fax"
  end

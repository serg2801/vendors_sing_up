class BoardsController < ApplicationController
  ...
  def board_params
    params.require(:board).permit(:legal_business_name, :company_name, :vendor_based_in, :vendor_based_in_other, :main_address_street, :main_address_unit, :main_address_city, :main_address_state,
                                  ...
                                  :average_inventory_replenishment_time_count, :average_inventory_replenishment_time_day, :costs_fees_radio, :w_9_form, :certificate, brands_attributes: [:id, :name, :board_id, :_destroy],
